...
#include "time.h"
 ...
 void m5d_test_inc(int m,int  n)
 {
    ...
    {
     	{
          ...
          m1ri_die("Error in m5d_inc size %d by %d,\n", m, n);
   ...
   for(int i = 0; i < m; i++)
    ...
    {
     	{
          m1ri_die("Error in m5d_inc and subtraction of size %d by %d,\n", m, n);
