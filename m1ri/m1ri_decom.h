...
/**
	...
	\ X replaces B
*/
void m3d_trsm_ur(m3d_t * L, m3d_t B);


void m5d_trsm_ur(m5d_t * L, m5d_t B);


void m7d_trsm_ur(m7d_t * L, m7d_t * B);
...
void m3d_trsm_ul(m3d_t const *U, m3d_t *B  );


void m5d_trsm_ul(m5d_t const *U, m5d_t *B );


void m7d_trsm_ul(m7d_t const *U, m7d_t *B);
...
void m3d_trsm_ll(m3d_t const *U, m3d_t *B);


void m5d_trsm_ll(m5d_t const *U, m5d_t *B);


void m7d_trsm_ll(m7d_t const *U, m7d_t *B);
...
void m3d_trsm_lr(m3d_t const *U, m3d_t *B );


void m5d_lower_r_triangular(m5d_t const *U, m5d_t *B);


void m7d_trsm_lr(m7d_t const *U, m7d_t *B);
